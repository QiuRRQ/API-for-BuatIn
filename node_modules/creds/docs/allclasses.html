...
<html lang="en">
	<head>
		...
		<title>Class Index | node-creds</title>
	...
	<div class="innerContent">
		<article>
			...
			<ul id="ClassList2">
					...
					<li>
						<h2 class="classname"><a href="symbols/creds.html">creds</a></h2>
						<p></p>
					</li>
				
					<li>
						<h2 class="classname"><a href="symbols/creds.roles.html">creds.roles</a></h2>
						<p></p>
					</li>
				
					<li>
						<h2 class="classname"><a href="symbols/creds.users.html">creds.users</a></h2>
						<p></p>
					</li>
